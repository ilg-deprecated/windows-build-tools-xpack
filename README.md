...
* commit all changes, use a message like `package.json: update urls for 8.2.0-2.2 release` (without `v`)
* update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v8.2.0-2.2.1_
* `npm version 8.2.0-2.2.1`
